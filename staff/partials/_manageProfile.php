<?php
    ...
    if(isset($_POST["updateProfilePic"])){
        ...
        if($check !== false) {
            ...
            $uploaddir = $_SERVER['DOCUMENT_ROOT'].'/DailyFreshOrderingSystem/staff/assetsForSideBar/img/';
    ...
    if(isset($_POST["removeProfilePic"])){
        $filename = $_SERVER['DOCUMENT_ROOT']."/DailyFreshOrderingSystem/staff/assetsForSideBar/img/person-".$userId.".jpg";
