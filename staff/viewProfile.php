                ...
                <div class="border p-3" style="border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 1.1rem;background-color: aliceblue;">
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Your Email" disabled value="<?php echo $email ?>">
                        </div>
                        <div class="form-row">
                            <div class="form-group  col-md-6">
						...
						<a href="forgot_pass_staff.php">Change Password</a>
                    </form>
                </div>
            </div>
        </div>
